'use strict';
    const APP_VERSION='step21-gemini-recipes-receipts-2026-06-02-01';
...
function renderSavedMealBanner(){
    ...
    function saveMealIdea(i){
      ...
      closeAllModals();
      render();
      toast('Ricetta salvata temporaneamente');
    }
